...
const ShapeMathPlusIcon = (0, react.forwardRef)(function ShapeMathPlusIcon(props, ref) {
...
//#endregion
exports.ShapeMathPlusIcon = ShapeMathPlusIcon;
exports.default = ShapeMathPlusIcon;
