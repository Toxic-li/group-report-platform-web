...
const ShapeQuadArrowIcon = (0, react.forwardRef)(function ShapeQuadArrowIcon(props, ref) {
...
//#endregion
exports.ShapeQuadArrowIcon = ShapeQuadArrowIcon;
exports.default = ShapeQuadArrowIcon;
