...
const ShapeBlockArcIcon = (0, react.forwardRef)(function ShapeBlockArcIcon(props, ref) {
...
//#endregion
exports.ShapeBlockArcIcon = ShapeBlockArcIcon;
exports.default = ShapeBlockArcIcon;
